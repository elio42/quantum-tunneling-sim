...
class FFT {
    ...
    public:
        ...
        static std::vector<std::complex<double>> inverse(const std::vector<std::complex<double>>& input);
        ...
        // Debugging function to print vectors
        static void print_vector(const std::vector<std::complex<double>>& vec);

    private:
        static std::vector<std::complex<double>> forward_recursive(const std::vector<std::complex<double>>& input);    
        static std::vector<std::complex<double>> inverse_recursive(const std::vector<std::complex<double>>& input);
