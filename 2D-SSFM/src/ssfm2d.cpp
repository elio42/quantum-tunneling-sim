...
*/
SSFM2D::SSFM2D(double N, double L, size_t padding, double dt_saftey_factor, int number_of_waves) : N(N), L(L), padding(padding), dt_saftey_factor(dt_saftey_factor), number_of_waves(number_of_waves) {
